...
class phonology_funcs:
    ...
    def create_phonological_matrix(self, labels, path_for_lexical_data):
        '''
            Description:
...
"""
amount,7.72832990734498,53497059.0
fable,6.095868543102137,1247006.0
fabled,5.515198043225131,327490.0
fables,5.932035697859989,855137.0
fabric,6.67388255510951,4719354.0
fabricate,5.35788341434534,227973.0
fabricated,5.946346134842693,883784.0
fabricating,5.314105384550749,206113.0
fabrication,6.054896746897735,1134741.0
fabricator,4.749960359903788,56229.0"""

"""
and,9.926774682044018,8448404166.0
being,8.324012695244333,210868979.0
carrot,5.910082532706829,812985.0
certify,5.8569305881242455,719334.0
chesterfield,5.652057686617788,448805.0
circumvent,5.6536793705978585,450484.0
circus,6.281662978710265,1912771.0
fish,7.344814257867427,22121484.0
is,9.483213845722629,3042382720.0
market,7.669130754336801,46679990.0"""

a_test_actual = ["a","a lot", "aaradvark", "aardvark","ab","aba","aba dose","aback","abacus","abalone"]
f_test_actual = ["amount","fable","fabled","fables","fabric","fabricate","fabricated","fabricating","fabrication","fabricator"]
s_test_actual = ["and","being", "carrot","certify","chesterfield","circumvent","circus","fish","is","market"]
phon = phonology_funcs()
# phon.create_phonological_matrix(a_test_actual, "/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test")
phon.create_phonological_matrix(f_test_actual, "/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test")
# phon.create_phonological_matrix(s_test_actual, "/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test")
# phon.create_phonological_matrix(f_test, "/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test")
# phon.create_phonological_matrix(s_test, "/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test")

# phon.create_phonological_matrix(s_smaller_test, "/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test")



#manual
# print(phon.normalized_edit_distance(phonology_funcs.wordbreak("and"), phonology_funcs.wordbreak("are")))


#testing to see if my handling of data was correct

# a_test_df = pd.read_csv(f"/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test/a_test.csv", header=None, names=["Word"])
# words_test_a = a_test_df["Word"].str.lower().tolist()
# print(words_test_a)