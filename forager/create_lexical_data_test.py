...
from forager.cues_og import get_labels_and_frequencies
from forager.cues_og import phonology_funcs
from forager.cues_og import create_semantic_matrix
import os 
...
class data: 
    ...
    def __init__(self, words, letter):
        self.path = '/Users/ulemjmunkhtur/Desktop/GitHub/task-discrepant-clustering/forager/data/lexical_data/phon_test'
        ...
        # get semantic matrix 
        create_semantic_matrix(self.path + f'/USE_embeddings.csv', self.path)
